...
<body onLoad="lod()">
	...
	<div class="box1">
		<div class="leftbox1" align="left">
			<form action="msgDelet.jsp" method="post">
				<div class="form-group">
					<label for="eId">Enter EmployeeId</label>
     					<input type="number" id="eId" name="eId" class="form-control" placeholder="Enter EmployeeId">
   				</div>
   				<div class="form-group">
