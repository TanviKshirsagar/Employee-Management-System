...
<body onLoad="lod()">
	...
	<div class="box1">
		<div class="leftbox1" align="left">
			<form action="msgEmpSalary.jsp" method="post">
				<div class="form-group">
					<label for="minSal">Minimum Salary</label>
     					<input type="number" id="minSal" name="minSal" class="form-control" placeholder="Enter Minimum Salary">
   				</div>
				<div class="form-group">
					<label for="maxSal">Maximum Salary</label>
     					<input type="number" id="maxSal" name="maxSal" class="form-control" placeholder="Enter Maximum Salary">
   				</div>
   				<div class="form-group">
