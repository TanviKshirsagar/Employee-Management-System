	...
	<div class="box1">
		...
		<div class="rightbox1" align="right">
			...
			try{
				...
				int minS =  Integer.parseInt(request.getParameter("minSal"));
				int maxS = Integer.parseInt(request.getParameter("maxSal"));
				
				String q = "select count(employeeId) as tEmp from employeeList where salary between ? and ?";
			...
			%>
				...
				Search Result By Salary Range Min Salary = <b><% out.print(minS);%></b> , Max Salary = <b><% out.print(maxS);%> </b> Total Employee Found = <b><%out.print(cnt);%></b>
			<%
				String q1 ="select * from employeeList where salary between ? and ?";
