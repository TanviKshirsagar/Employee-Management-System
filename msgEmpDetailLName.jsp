	...
	<div class="box1">
		...
		<div class="rightbox1" align="right">
			...
			try{
				...
				String q = "select count(employeeId) as tEmp from employeeList where lastName=?";
			...
			%>
				...
				Search Result By First-Name = <b><% out.print(eLn);%></b> Total Employee Found = <b><%out.print(cnt);%></b>
			<%
				String q1 ="select * from employeeList where lastName=?";
