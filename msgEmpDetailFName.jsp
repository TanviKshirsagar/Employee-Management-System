	...
	<div class="box1">
		...
		<div class="rightbox1" align="right">
			...
			try{
				...
				String q = "select count(employeeId) as tEmp from employeeList where firstName=?";
			...
			%>
				...
				Search Result By First-Name = <b><% out.print(eFn);%></b> Total Employee Found = <b><%out.print(cnt);%></b>
			<%
				String q1 ="select * from employeeList where firstName=?";
			...
			<table id="msgTable" class="table table-bordered table-hover">
				<thead>
					<tr>
