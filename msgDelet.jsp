...
<body onLoad="lod()">
	...
	try{
		...
		String q="delete from employeelist where employeeId = ?";
	...
	<div class="box1">
		<div class="leftbox1" align="left">
			...
			<a href="#showEmployee">Show Employee Details</a><br/><br>
			<p>Deleted Employees Information With ID = <% out.println(eId); %>
		</div>
