...
<body onLoad="lod()">
	...
	try{
		...
		String q1="update employeelist set firstName=?, lastName=?, email=?, departmentName=?, departmentId=?, designation=?, salary=?, address=?  where employeeId=?";
	...
	<div class="box1">
		<div class="leftbox1" align="left">
			...
			<p>Updated Employees Information With ID = <% out.println(eId); %>
		</div>
		<div class="rightbox1" align="center">
			<%		
				...
				ResultSet rs = stat.executeQuery(q2);
			%>
